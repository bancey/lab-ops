...
containers = {
  ...
  matter-server = {
    node                = "hela"
    ct_id               = 260
    ct_description      = "Matter Server LXC Container. Provides Matter controller and Thread Border Router (OTBR) for Home Assistant."
    cpu_cores           = 2
    memory              = 2048
